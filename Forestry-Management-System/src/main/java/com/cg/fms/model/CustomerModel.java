...
public class CustomerModel {
	...
	@NotNull(message="customerAddress cannot be omitted")
	private String customerAddress;
	
	@NotEmpty(message="customerTown  cannot be empty")
	@NotNull(message="customerTown cannot be omitted")
	private String customerTown;	
	
	@NotEmpty(message="customerPostalCode  cannot be empty")
	@NotNull(message="customerPostalCode cannot be omitted")
	...
	public CustomerModel(String customerId,
			...
			@Email(message = "email must be a valid one") @NotNull(message = "email cannot be omitted") String customerEmail,
			@NotEmpty(message = "customerAddress  cannot be empty") @NotNull(message = "customerAddress cannot be omitted") String customerAddress,
			@NotEmpty(message = "customerTown  cannot be empty") @NotNull(message = "customerTown cannot be omitted") String customerTown,
			@NotEmpty(message = "customerPostalCode  cannot be empty") @NotNull(message = "customerPostalCode cannot be omitted") String customerPostalCode,
			@Pattern(regexp = "[1-9][0-9]{9}", message = "contact number is expected to be 10 digits and should not start with 0") @NotNull(message = "contact number cannot be omitted") String customerContact) {
		super();
...
//		this.orderNumber = orderNumber;
	...
	public String toString() {
		return "CustomerModel [customerId=" + customerId + ", customerName=" + customerName + ", customerPassword="
				...
				+ customerContact + ", contractNumber=" + contractNumber + ", orderNumber=" + orderNumber + "]";
	}
